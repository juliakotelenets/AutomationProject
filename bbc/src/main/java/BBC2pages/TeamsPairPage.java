...
public class TeamsPairPage extends BasePage {
    ...
    public TeamsPairPage(WebDriver driver) { super(driver); }

    @FindBy(xpath = "//article[contains(@class,'fixture')]//div[contains(@class,'fixture')]")
    private List<WebElement> listOfTeams;

    public WebElement getTeamByIndex(int index){return listOfTeams.get(index);}

    public List<String> getTeamsNamesString(WebElement teams){ return Arrays.asList(teams.getText().split("\n")); }
