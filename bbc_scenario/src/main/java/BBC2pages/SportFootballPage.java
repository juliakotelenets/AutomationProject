...
public class SportFootballPage extends BasePage {
    ...
    public WebElement getFootballSectionsButtonByIndex(int index){return listOfFootballSectionsButton.get(index);}
    ...
    public WebElement getPairOfTeamsByIndex(int index){return listOfTeams.get(index);}

    public void clickOnPairOfTeamsByIndex(int index){getPairOfTeamsByIndex(index).click();}

    public List<String> getTeamsPairString(WebElement teams){ return Arrays.asList(teams.getText().split("\n")); }
    ...
    public List<WebElement> getListOfMonthsYears(){return listOfMonthsYears;}

    public WebElement getMonthYearByIndex(int index){return listOfMonthsYears.get(index);}
